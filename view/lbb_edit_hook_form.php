		...
		<div class="bodyParams" style="display:none">
		  ...
		  <input type="radio" name="formdata_type" value="raw-data" onclick="jQuery('.form-data').hide();jQuery('.raw-data').show();">Raw Data
			...
			<table class="appendBodyDiv raw-data" <?php if($data["form-data"] == "row-data"){}else{echo "style='display:none'";} ?>>
				<tr>
					<td>
					  <textarea class="raw-form-data-area" name="body-raw-value" rows="4" cols="50">
						<?php echo $result["data"]; ?></textarea>
			    </td>
				</tr>
			</table>
		</div>
...
<div class="headerResponse" style="">
	<table class="appendHeaderResponse">
		<tr>
			<td><textarea class="headerResponse" rows="4" cols="50"><?php echo $response["header"]; ?></textarea></td>
		</tr>
	</table>
</div>
<div class="bodyResponse">
	<table class="appendBodyResponse">
		<tr>
			<td><textarea class="bodyResponse" rows="10" cols="70"><?php echo $response["body"]; ?></textarea></td>
		</tr>
	</table>
</div>
